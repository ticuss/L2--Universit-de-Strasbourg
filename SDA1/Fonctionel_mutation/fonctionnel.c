...
/**
 * \mainpage Files fonctionnelles
 *
 *
 * Le programme \c \b fonctionnel permet de tester l'implémentation d'une ::file
 * fonctionnelle d'éléments de sorte ::S et de taille #TAILLE_MAX. Voir la
 ...
 * \endcode
 *
 * Le binaire produit se nomme \c \b fonctionnel. Pensez à utiliser \c \b ledit
